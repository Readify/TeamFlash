...
namespace TeamFlash
{
    internal class Program
    {
        ...
        private static TeamFlashConfig LoadConfig()
        {
        ...
        private static void SaveConfig(TeamFlashConfig config)
        {
            ...
            XmlSerializer serializer = new XmlSerializer(typeof (TeamFlashConfig));
